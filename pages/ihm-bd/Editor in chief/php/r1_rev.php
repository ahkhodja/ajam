                ...
                <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            ...
                            <label for="text" class=" control-label text-left texte text_label" ><?php echo $row['etiquette'].sprintf('%04d',$id_article); ?> </label>
        ...
        <td class='texte'>".$co_row['email']."</td>
                ...
                <div class="row decision " id="add_rev">
                    ...
                    <div class="form-group">
                        ...
                        <label for="textarea" class="col-lg-1 control-label bordure_n "><span class="titre_select"> Review </span> </label>
                        <div class="col-lg-8">
                        ...
                        <div class="col-lg-2">
                            ...
                            <button type="button" class="btn btn-primary" id="send_rev"> Send </button> <img src="../images/gears.gif" style="display: none;" id="wait">
                ...
                <div class="row">
                    ...
                    <?php
                    $review=$conn->query("SELECT reviewer,date_accepte,resultat,date_result,date_reject,date,state from state_review WHERE article=".$id_article." AND type='review 2'");
                    if($review)
                    {
