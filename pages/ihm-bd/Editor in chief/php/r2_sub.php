    ...
    <tbody>";
      ...
      <tr>
        ...
        <td class='texte'>".$co_row['email']."</td>
                ...
                echo"
<div class=\"row\"><legend class='texte_legend'>Reviewers Suggested</legend> </div>
<div class=\"row\">
    <table class=\"table table-striped\" >
    <thead>
      <tr>
      ...
      <tr>
        ...
        <td class='texte'>".$row2['email']."</td>
                ...
                <div class="row">
                    ...
                    <?php
                    $review=$conn->query("SELECT reviewer,date_accepte,resultat,date_reject,date_result,date,state from state_review WHERE article=".$id_article." AND type='review 3'");
                    if($review)
                    {
...
<p style=color:red;>". nl2br($row_rev['Confidential'])."</p>
                ...
                <div class="row">
                    ...
                    <?php
                    $review=$conn->query("SELECT reviewer,date_accepte,resultat,date_reject,date_result,date,state from state_review WHERE article=".$id_article." AND type='review 1'");
                    if($review)
                    {
                        if ($review->num_rows != 0)
                        {
...
<p style=color:red;>". nl2br($row_rev['Confidential'])."</p>
                ...
                <div class="row decision_sec">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-5">
                            ...
                            <select name="decision" id="decision" value="" class="form-control texte">
                                ...
                                <option value="Reject" class='texte'>Reject</option>
                                <option value="Accept" class='texte'>Accept</option>
                    ...
                    <div class="row decision" id="transmit">
                        <div class="form-group comment_decision ">
                            <div class="col-lg-12 bordure_n ">
                                <textarea  name="decision" rows="15" class="form-control" id="comment_text" placeholder ="Comments ..."></textarea>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-1">
                                ...
                                <button type="button" class="btn btn-primary" id="accepte"> Submit </button>
    ...
    <script type="application/javascript">
        $(function(){
            ...
            $('#accepte').click( function (){
                ...
                dec=$("#comment_text").val();
                alert(dec);
                data_sub="ar="+idar+"&file="+file+"&dec="+dec+"&e_ed="+e_ed+"&auth="+idau;
