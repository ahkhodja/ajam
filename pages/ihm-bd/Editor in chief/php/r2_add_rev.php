...
$add=$conn->query("INSERT INTO state_review (article,file,cle,reviewer,cle2,date,type)values(".$id_article.",".$id_file.",'".$cle."',".$id_rev.",'".$cle2."',now(),'review 3')");
...
<p>If you agree to review this paper, please click this link:  http://localhost/ajam/pages/ihm-bd/review/review3.php?c1=".$cle."&c2=".$cle2."&rsa=".$id_etat."&f=".$id_file."&et_ed=".$et_ed."&b=".$editor." </p>
