...
$select_editor=$conn->query("SELECT e.fname,e.lname,e.email,s.editor FROM state_editor s,editor e WHERE s.article=".$id_article." AND e.id=s.editor");
    ...
    <div class="row menu_row">
        <div class="col-sm-2 menu">
            <div class="row profile">
                <div class="hed"> <p>Editor</p></div>
                <div class="col-sm-4 pading_left">
                    <img src="../images/profile.png" id="profile">
                </div>
                <div class="col-sm-7 pading_profile_e text_moyen">
                    <div class="form-group">
                        <div class="row min_height">
                            <label class="col-lg-12 control-label no_padding font_14  text-center" for="text"><?php echo $row_editor['fname']." ".$row_editor['lname']; ?>  </label>

                        </div>
                        <div class="row min_height">

                            <label class="col-lg-12 control-label no_padding text_label" for="text">&nbsp;<?php echo"". $row_editor['email']  ?> </label>
                        </div>
      ...
      <tr>
        ...
        <td class='texte'>".$row2['email']."</td>
                ...
                <div class="row">
                    ...
                    <?php
                    $review=$conn->query("SELECT reviewer,date_accepte,resultat,date_result,date,state from state_review WHERE article=".$id_article." AND type='review 3'");
                    if($review)
                    {
