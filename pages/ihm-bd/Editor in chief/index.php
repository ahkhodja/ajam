...
$all_ar=$conn->query("SELECT COUNT(*) FROM state_editor WHERE etat='Draft Submited' or etat='-Draft Submited-'");
$all_ar_count = $all_ar->fetch_array();
if(isset($_GET['t'])){
    include_once("../../../php/cnx.php");
    if($_GET['t']=='all_ar') {


        $sql = "SELECT id,article,file, DATE_FORMAT(date, '%d %M') as date,vu FROM state_editor WHERE  etat='-Draft Submited-' OR etat='Draft Submited'";
        $select = $conn->query($sql);
        if ($select->num_rows != 0) {

            $contenu = "<div id=\"contenu\"><legend> &nbsp;ALL ARTICLES :</legend>
...
";
            while($row = $select->fetch_assoc()){
	  	   ...
	  	   <tr ".$vu.">
                ...
                <td><a ".$vu_lien."  onclick=\"window.open(this.href); return false;\"   href=\"php/ar_inf_all.php?idar=".$row['article']."&et_e=".$row['id']."\">". $row2['title']."</a></td>
...
";
	   ...
	   <tr ".$vu.">
                <td>". $row2['etiquette']. sprintf('%04d',$row2['id'])."</td>
                <td><a ".$vu_lien." onclick=\"window.open(this.href); return false;\"   href=\"php/r1_dec.php?idar=".$row['article']."&et_e=".$row['id']."&idau=".$row2['author']."\">". $row2['title']."</a></td>
                ...
                <div class='container'>
                    ...
                    <div class=\"row\">
                        ...
                        <div class=\"form-group\">
                            ...
                            <div class=\"col-lg-2 line_height\"><button type=\"button\" class=\"btn btn-primary\" id='env'>Submit</button> <img src=\"images/gears.gif\" style=\"display: none\" id=\"wait\"></div>
...
<div class="container-fluid">
    ...
    <div class="row bann">
        <div class="col-sm-2 logo">
            <a class="no_color" href="index.php?t=d_sub"> <p class="text-center">Editor in  chief </p></a>
        </div>
            ...
            <div class="row menu">
                <div class="panel panel-info panel_perso">
                    ...
                    <div class="list-group">
                        ...
                        <a href="index.php?t=ma_editor" class="list-group-item liste_perso" >
                    ...
                    <div class="list-group">
                        ...
                        <li <?php if(isset($_GET['t'])){ if($_GET['t']=='all_ar') {echo " class=\"selected\"";}}  ?>>
                            <a href="index.php?t=all_ar" class="list-group-item liste_perso">
                                <i class ="fa   fa-search fa-2x "></i>	  &nbsp;ALL ARTICLES<span class="pull-right nombre">(<?php echo $all_ar_count[0]; ?>)</span>
