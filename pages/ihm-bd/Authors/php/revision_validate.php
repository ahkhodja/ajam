    ...
    if($inser){
        ...
        if($delete){
            ...
            if($inser){
                ...
                $inserfile=$conn->query("INSERT INTO file (name, size,article,type) VALUES ('ajam_R1_".$idarticle.".pdf','',".$idarticle.",'AJAM-R')");
                rename("../files/".$idauthor."/".$idarticle."/source/temp/".$filename."","../files/".$idauthor."/".$idarticle."/ajam_R1_".$idarticle.".pdf");
...
<tr>
<td>Manuscript ID</td>
<td>AJAM-R1-".date('y')."/".$idarticle."</td>
</tr>
<tr>
<td>Article Type</td>
<td>".$type."</td>
...
<td>".$keywords."</td>
                ...
                $outputt=exec("gswin64c -dBATCH -dNOPAUSE -q -sDEVICE=pdfwrite -sOutputFile=ajam_R1_".$idarticle."_.pdf file.pdf ajam_R1_".$idarticle.".pdf ");
                chdir('C:\sites\ajam\pages\ihm-bd\Authors\php');
                //tester l'existance du fichier
                $inserfile=$conn->query("INSERT INTO file (name, size,article,type) VALUES ('ajam_R1_".$idarticle."_.pdf','',".$idarticle.",'AJAM-D')");
