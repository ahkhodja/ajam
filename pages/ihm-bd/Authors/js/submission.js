...
if($('.block tr').length!=0){
    ...
    $("#next_4").click(function(e) {
        ...
        $.ajax({
            type:"POST",
            url:"php/submit_article.php",dataType: "json",
    ...
    $(document).on('change', '#main', function(){
            ...
            if (res){
                ...
                if(size>1024){
                    size=size/1024;
                    size=size.toFixed(2)+' Mo'

                }else{
                    size=size.toFixed(2)+' Ko'
                }
                //alert(size);
                $("#file_taille").html(size);
                ...
                request.upload.addEventListener('error',function(event){
                    ...
                    //supprimer l'image du tableau et decrement� le compteur
                });
