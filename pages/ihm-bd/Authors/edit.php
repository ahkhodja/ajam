...
$select_editor=$conn->query("SELECT id,editor FROM state_editor WHERE article=".$id_article." AND etat='Pre_Submited'");
    ...
    <div class="col-lg-12">
        <nav class ="navbar navbar-inverse">
            <div class ="navbar-header ">
                <a class ="navbar-brand " href ="#">Author Account </a>
            </div>
        ...
        <div id="contenu">
            <form class="form-horizontal col-lg-12" enctype="multipart/form-data" id="form" method="post">
                <div id="pi" class="partie">
                    ...
                    <div class="row">
                        <?php echo"<input type='hidden' id='editor_selected' value='".$row_editor['editor']."'>";?>
                        <?php echo"<input type='hidden' id='etat_editor' value='".$row_editor['id']."'>";?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                ...
                                <?php echo"<input type='hidden' id='editor' value='".$data['id']."'>";?>
                            </div>
                ...
                <div class="partie"> <div class="traitement"><img src="images/gif.gif" id="gif"></div></div>
