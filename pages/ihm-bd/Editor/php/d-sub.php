                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-5">
                            ...
                            <select name="decision" id="decision" value="" class="form-control texte">
                                ...
                                <option value="refused" class='texte'>Reject as it is</option>
                                <option value="Transfer to Editor-in-Chief" class='texte'>Transfer to Editor-in-Chief</option>
    ...
    <script type="application/javascript">
        $(function(){
            ...
            $("#decision").change(function(){
                ...
                if(resultat=='Transfer to Editor-in-Chief')
                {$("#transmit").show();
            ...
            $('#transmit_e').click( function (){
                ...
                data_sub="&e_ed="+e_ed+"&comment="+comment;
                console.log(data_sub);
                $.ajax({
