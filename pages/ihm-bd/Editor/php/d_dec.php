...
$select_decision=$conn->query("SELECT id,decision,type,date FROM decision WHERE article=".$id_article." AND type='Draft Revision'");
?>
<!doctype html>
...
<p style=color:red;>". nl2br($row_rev['Confidential'])."</p>
                ...
                <?php if($select_decision->num_rows==0) echo"<div class=\"row\" >
    ...
    <script type="application/javascript">
        ...
        $('#acc_w_bt').click( function (){
            $("#wait").show();
            dec=$("#decision").val();
            data_sub="ar="+idar+"&dec="+dec+"&e_ed="+e_ed+"&f="+file+"&auth="+idau;
