...
$sql="SELECT id,article,file, DATE_FORMAT(date, '%d %M') as date FROM state_editor WHERE editor=".$id_editor." AND etat='waiting_review'";
...
";
    while($row = $select->fetch_assoc()){
	   ...
	   <tr>
                <td>". $row2['id']."</td>
                <td><a  onclick=\"window.open(this.href); return false;\"   href=\"php/show2.php?idar=".$row['article']."&et_e=".$row['id']."&idau=".$row2['author']."\">". $row2['title']."</a></td>
